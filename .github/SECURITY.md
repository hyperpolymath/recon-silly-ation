...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/recon-silly-ation/security/advisories/new)
...
No PGP key is published for this project at present; if encryption is required, say so in your first message and we'll arrange a channel.
...
- This repository (`hyperpolymath/recon-silly-ation`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/recon-silly-ation/security/advisories)
...
When using recon-silly-ation, we recommend:
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/recon-silly-ation/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/recon-silly-ation/discussions) |
...
*Thank you for helping keep recon-silly-ation and its users safe.* 🛡️
