...
# recon-silly-ation container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping recon-silly-ation..."
...
echo "Starting recon-silly-ation..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/recon-silly-ation
#   exec /app/release/bin/recon-silly-ation start
#   exec /app/recon-silly-ation serve --host "${APP_HOST}" --port "${APP_PORT}"
